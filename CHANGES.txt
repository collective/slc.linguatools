...
- Add support for slc.outdated [thomasw] 

1.3.7 (2011-03-01)
------------------

- replaced getTranslationService with zope.i18n [thomasw]
- added error handling for non-translatable target (cut&paste) [thomasw]
